...
<x-layout>
    ...
    <section class="max-w-7xl mx-auto px-6 py-16 space-y-20">
        <!-- INTRO -->
        <div class="grid md:grid-cols-2 lg:gap-14 gap-10 items-center">
            <div>
            ...
            <div class="relative">
                <img src="{{ asset('img/warranty-2.jpg') }}" alt="Warranty Illustration"
                    class="rounded-2xl w-full h-96 object-contain">
            </div>
        </div>
