        ...
        <div class="flex items-center mb-4">
            ...
            <div>
                <a href="/dashboard/news/create"
                    class="p-2 bg-slate-100 hover:bg-gray-200 border rounded-md text-primary-500 border-primary-400 text-sm">Add
                    Article</a>
            </div>
        </div>
                ...
                <table class="w-full text-sm text-left text-gray-500">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            <th scope="row"
                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">Article About
                                Thing</th>
                            <td class="px-4 py-3">James Kamerun</td>
                            <td class="px-4 py-3">News</td>
