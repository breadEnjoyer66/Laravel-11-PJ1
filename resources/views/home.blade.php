<x-layout>
    ...
    <div class="py-20 mx-auto text-center lg:py-24">
        <a href="/about"
            ...
            role="alert">
            <span class="text-xs bg-primary-600 rounded-full text-white px-4 py-1.5 mr-3">Learn about us</span> <span
                class="text-sm font-medium">Primajaya Multi Technology</span>
        ...
        <p class="mb-8 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Providing
