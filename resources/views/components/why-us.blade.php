    ...
    <div class="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
        ...
        <div class="flex items-start gap-4 py-5 px-3">
            ...
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400">HP, Asus, Lenovo, Brother, Cisco, Synology, Apple,
                    and
                    many more.</p>
            </div>
        </div>
        ...
        <div class="flex items-start gap-4 py-5 px-3">
            ...
            <div>
                ...
                <p class="text-gray-500 dark:text-gray-400">From authorized suppliers and professional team.
                </p>
            </div>
        </div>
