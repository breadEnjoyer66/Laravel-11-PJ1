    ...
    <div class="border bg-slate-100 py-6 lg:py-12 px-8 rounded-xl lg:flex w-full flex-col lg:flex-row gap-10 lg:gap-20">
        <div class="py-5 lg:py-0 flex flex-col lg:items-start items-center justify-center lg:w-1/3">
            ...
            <div class="flex">
                ...
                <p class="italic text-gray-600">(061) 7369900</p>

            </div>
            <a href="https://maps.app.goo.gl/xJjPU1dpcNdeRhEq9" target="_blank" rel="noopener noreferrer"
                class="bg-primary-500 text-white px-4 py-2 rounded-full text-sm mt-5 mb-5 lg:mb-0">Open in
                maps</a>

        </div>
        <div class="lg:w-2/3 border border-gray-100 rounded-xl">
