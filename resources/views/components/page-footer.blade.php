    ...
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-10">
            ...
            <div class="grid grid-cols-2 gap-8 lg:gap-12 sm:gap-6 sm:grid-cols-3">
                ...
                <div>
                    ...
                    <ul class="text-gray-600 dark:text-gray-400">
                        ...
                        <li class=" text-sm">
                            <a href="https://wa.me/6281380009898" class="hover:underline text-primary-500"
                                target="_blank">0813 8000
                                9898
                            </a>

                        </li>
                        {{-- <li class="mb-4 text-sm">
                            <a href="https://wa.me/6282364506105" class="hover:underline text-primary-500"
                                target="_blank">0823 6450
                                6105
                            </a>
                        </li> --}}
                    </ul>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            ...
            <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
                ...
                <a href="https://www.instagram.com/primajayatechnology?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw=="
                    class="text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                        <path fill-rule="evenodd"
