        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
            ...
            <div class="text-center space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
                <div class="bg-gradient-to-b from-white to-gray-100 rounded-xl px-5 py-10 shadow-md">
                    <div
                        class="mx-auto flex justify-center items-center mb-4 w-10 h-10 rounded-full w-16">
                        ...
                        <img src="{{ asset('img/icons/service-icon.png') }}" alt="client-1">
                    </div>
                ...
                <div class="bg-gradient-to-b from-white to-gray-100 rounded-xl px-5 py-10 shadow-md">
                    <div
                        ...
                        <img src="{{ asset('img/icons/retail-icon.png') }}" alt="client-1">
                    </div>
                ...
                <div class="bg-gradient-to-b from-white to-gray-100 rounded-xl px-5 py-10 shadow-md">
                    <div
                        ...
                        <img src="{{ asset('img/icons/manufacture-icon.png') }}" alt="client-1">
                    </div>
                ...
                <div class="bg-gradient-to-b from-white to-gray-100 rounded-xl px-5 py-10 shadow-md">
                    ...
                    class="mx-auto flex justify-center items-center mb-4 w-10 h-10 rounded-full w-16">
                        ...
                        <img src="{{ asset('img/icons/education-icon.png') }}" alt="client-1">
                    </div>
                ...
                <div class="bg-gradient-to-b from-white to-gray-100 rounded-xl px-5 py-10 shadow-md">
                    ...
                    class="mx-auto flex justify-center items-center mb-4 w-10 h-10 rounded-full w-16">
                        ...
                        <img src="{{ asset('img/icons/consumer-good-icon.png') }}" alt="client-1">
                    </div>
                ...
                <div class="bg-gradient-to-b from-white to-gray-100 rounded-xl px-5 py-10 shadow-md">
                    ...
                    class="mx-auto flex justify-center items-center mb-4 w-10 h-10 rounded-full w-16">
                        ...
                        <img src="{{ asset('img/icons/e-procurement-icon.png') }}" alt="client-1">
                    </div>
